    ...
    class IncrementRequestTests
    {
        ...
        class Bulk
        {
            ...
            public void Failure()
            {
                ...
                var result = client.IncrementBulkData(datapoints2);
                var expected = new Response<Nothing>(new Nothing(), 403);
            ...
            public void RequestMethod()
            {
                ...
                client.IncrementBulkData(datapoints1);
            ...
            public void RequestUrl()
            {
                ...
                mockclient.Verify(cl => cl.Execute(It.Is<RestRequest>(req => req.Resource == "/{version}/increment/")));
            }
